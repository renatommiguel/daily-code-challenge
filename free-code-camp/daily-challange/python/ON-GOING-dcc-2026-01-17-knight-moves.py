...
Tests
    ...
    Waiting: 1. knight_moves("A1") should return 2.
    Waiting: 2. knight_moves("D4") should return 8.
    Waiting: 3. knight_moves("G6") should return 6.
    Waiting: 4. knight_moves("B8") should return 3.
    Waiting: 5. knight_moves("H3") should return 4.
"""